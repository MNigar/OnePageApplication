...
namespace WebApplication7.Areas.Manage.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,PreTitle,Text,Signature")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,PreTitle,Text,Signature")] About about)
        {
            if (ModelState.IsValid)
            {
