...
namespace WebApplication7.Areas.Manage.Controllers
{
    public class SkillsController : Controller
    {
        ...
        // GET: Manage/Skills/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Manage/Skills/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,Point,Name")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Point,Name")] Skill skill)
        {
            if (ModelState.IsValid)
            {
