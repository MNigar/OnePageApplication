...
namespace WebApplication7.Areas.Manage.Controllers
{
    public class FeaturesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Icon,Description,Name")] Feature feature)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Icon,Description,Name")] Feature feature)
        {
            if (ModelState.IsValid)
            {
